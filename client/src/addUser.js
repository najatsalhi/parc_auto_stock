...
function AddUser () {
    ...
    const handleSubmit = (vald) => {
       ...
       if (errors.nom ==="" && errors.prenom ==="" && errors.email ==="" && errors.password ===""&& errors.role ===""){
    ...
    <div className='d-flex justify-content-center'>
            ...
            <h1 style={{color:'black', textAlign:'center'}}>Ajouter</h1>
                <form action="" onSubmit={handleSubmit}>
                    <div className='mb-3'>
                        <label htmlFor="name">Nom</label><br></br>
                        <input type="text" placeholder='nom' name="nom" id="nom" 
                        onChange={handleInput}/>
                        {errors.nom && <span class='text-danger'>{errors.nom}</span>}
                    </div>
                    <div className='mb-3'>
                        <label htmlFor="prenom">Nom</label><br></br>
                    ...
                    <div className='mb-3'>
                        ...
                        <select placeholder='Role' name="role" id="list-select" onChange={handleInput}> 
                    ...
                    <Link to='/' className='btn_btn_default'>Annuler</Link>
                </form>
            </div>
    </div>
    )
